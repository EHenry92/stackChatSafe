...
const WRITE_NEW_CHANNEL = 'WRITE_NEW_CHANNEL';
...
export function writeNewChannel (channelName) {
  const action = { type: WRITE_NEW_CHANNEL, channelName };
  return action;
}
...
export function fetchNewChannel (channelName, history) {
